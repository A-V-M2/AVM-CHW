...
})({"bfvAS":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a9d907fc08925702";
"use strict";
...
},{}],"c9wT3":[function(require,module,exports) {
...
const orbGeometry = new _three.SphereGeometry(1, 32, 32);
const orbMaterial = new _three.MeshBasicMaterial({
    color: 0xffffff
});
const orb = new _three.Mesh(orbGeometry, orbMaterial);
scene.add(orb);
...
const blackBox = new _three.Mesh(boxGeometry, boxMaterial);
...
document.getElementById("animationButton").addEventListener("click", ()=>{
    new _three.VectorKeyframeTrack(".position", [
        0,
        1
    ], [
        0,
    ...
    new _three.NumberKeyframeTrack(".scale", [
        0,
        1
    ], [
        1,
...
new TWEEN.Tween(orb.position).to({
    x: 5
}, 1000).start();
new TWEEN.Tween(orb.scale).to({
    x: 0.5,
    y: 0.5,
    z: 0.5
}, 1000).start();
new TWEEN.Tween(blackBox.position).to({
    x: -3
}, 1000).start();
function animate() {
    requestAnimationFrame(animate);
...
},{"three":"ktPTu"}]},["bfvAS","c9wT3"], "c9wT3", "parcelRequire6f74")

//# sourceMappingURL=index.08925702.js.map
