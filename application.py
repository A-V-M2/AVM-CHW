...
def translate(input):
  ...
  elevenlabs_api_key = "c651e4e0c5a0db498144828e68cc8dc0"
  elevenlabs_voice_id = "eBbWyvt9h7JOW9HmCqZx"
  ...
  audio = client.generate(text, voice=elevenlabs_voice_id)
...
while ux < var:
    ...
    ux += 1
    """
#ui_prompt = 'where do I go if the hospital shant be openx